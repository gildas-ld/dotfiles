...
alias -g rsync="rsync -ahz --numeric-ids --stats --info=progress2"
...
alias cp="cp -iva"
alias cp="rsync -ahz --numeric-ids --stats --info=progress2"
alias dl="aria2c"
alias dud='du -d 1 -h'
...
alias rsync="rsync -ahz --numeric-ids --stats --info=progress2"
