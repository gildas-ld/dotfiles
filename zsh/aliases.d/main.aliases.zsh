...
alias ee="exit"
alias eenv="nvim /home/gildas/.zshenv"
alias eev="nvim /home/gildas/.zshenv"
...
alias evenv="nvim /home/gildas/.zshenv"
...
alias sm='nohup smerge "${1:-.}" >/dev/null 2>&1 &'
...
alias stpn="systemctl poweroff -i"
alias sy="symfony"
alias t="tmux"
alias ta='tmux attach -t || tmux new-session -s'
