...
keybinds_conf="$HOME/.config/waybar/configs/Keybinds.conf"
user_keybinds_conf="$HOME/.config/waybar/UserConfigs/UserKeybinds.conf"
laptop_conf="$HOME/.config/waybar/UserConfigs/Laptops.conf"
