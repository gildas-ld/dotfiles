...
user_pref('browser.safebrowsing.provider.google.advisoryName', 'Gogol Relatively Safe Browsing');
...
user_pref('startup.homepage_welcome_url.additional', 'about:setup | about:config');
